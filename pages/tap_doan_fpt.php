<div class="content">
    ...
    <div class="box-fpt-1">
        <div class="container">
            <div class="b-title">
                <a>
                    <img src="assets/images/fpt/icon-info.png" alt="icon-info.png">
    ...
    <div class="box-fpt-3">
        <div class="container">
            <div class="b-title">
                <a>
                    <img src="assets/images/fpt/i-setting-1.png" alt="i-setting-1.png">
            ...
            <div class="b-content row">
                ...
                <div class="col-sm-12 col-lg-7 b-content-img">
                    <img src="assets/images/fpt/technology-orientation.png" alt="technology-orientation.png">
                </div>
            </div>
        </div>
    </div>
    <div class="box-fpt-4">
        <div class="container">
            <div class="b-title">
                <a>
                    <img src="assets/images/fpt/icon-global-network.png" alt="icon-global-network.png">
                    <span>MẠNG LƯỚI TOÀN CẦU</span>
                </a>
            </div>
            <div class="b-content row">
                <div class="col-sm-12 col-lg-5 b-content-img">
                    <img src="assets/images/fpt/global-network.png" alt="global-network.png">
                </div>
    ...
    <div class="box-fpt-5">
        <div class="container">
            <div class="b-title">
                <a>
                    <img src="assets/images/fpt/i-customer-1.png" alt="i-customer-1.png">
